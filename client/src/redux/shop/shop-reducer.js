...
export const FETCH_COLLECTION_STARTED = 'shop/FETCH_COLLECTION_STARTED';
export const FETCH_COLLECTION_SUCCEEDED = 'shop/FETCH_COLLECTION_SUCCEEDED';
export const FETCH_COLLECTION_FAILED = 'shop/FETCH_COLLECTION_FAILED';
